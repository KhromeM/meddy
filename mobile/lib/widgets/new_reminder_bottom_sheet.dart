...
class AddReminderBottomSheet extends StatefulWidget {
  ...
  const AddReminderBottomSheet({Key? key, required this.onAddReminder})
      : super(key: key);
                    ...
                    ElevatedButton(
                      onPressed: () {
                        widget.onAddReminder(
                            reminderDate, reminderTime, _repeatOption);
          ...
          builder: (context, languageProvider, child) {
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(
                  child: Text(languageProvider.translate('discard_changes'),
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () => Navigator.of(context)
                        .pop(languageProvider.translate('daily')),
                  ),
                  ListTile(
                    title: Text(languageProvider.translate('weekends')),
                    onTap: () => Navigator.of(context)
                        .pop(languageProvider.translate('weekends')),
                  ),
                  ListTile(
                    title: Text(languageProvider.translate('weekdays')),
                    onTap: () => Navigator.of(context)
                        .pop(languageProvider.translate('weekdays')),
                  ),
                  ListTile(
                    title: Text(languageProvider.translate('never')),
                    onTap: () => Navigator.of(context)
                        .pop(languageProvider.translate('never')),
                  ),
                ],
              ),
            );

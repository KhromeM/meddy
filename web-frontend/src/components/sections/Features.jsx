...
import reminderChatGif from "../../assets/gif/set-reminder-flutter.gif";
...
const FeatureCard = ({ children, isEven, index, icon, url, onImageChange }) => {
	...
	return (
		...
		>
			...
			<Image src={icon} alt="Feature Icon" boxSize="40px" ml={4} zIndex={1} />
		</Box>
	);
};
			...
			<Center flex={1.2} height="100%">
				<VStack align="stretch" spacing={6} width="100%">
					...
					<FeatureCard
						...
						url={normalChatGif}
					>
						Forgot your doctor's recommendation? No problem.
					</FeatureCard>
					<FeatureCard
						onImageChange={updateImage}
						isEven={true}
					...
					>
						{" "}
						Daily personalized advice to improve your health.
					</FeatureCard>
					<FeatureCard
						onImageChange={updateImage}
						isEven={false}
					...
					<FeatureCard
						...
						url={healthInfoGif}
					>
						Medical insights generated by analyzing all your data.
					</FeatureCard>
				</VStack>
			</Center>
		</Flex>

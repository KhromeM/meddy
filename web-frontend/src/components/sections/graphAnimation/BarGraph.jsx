...
const BarGraph = () => {
  return (
    <div style={{ textAlign: 'center', margin: 'auto', width: '75%', marginTop: '5%'}}> {/* Center the graph */}
      <h3 style={{ fontSize: '18px', marginBottom: '10px', color: '#333' }}>Performance Comparison</h3> {/* Add a title */}

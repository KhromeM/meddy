	...
	try {
		...
		const responseSchema = {
			...
			items: {
				type: "string",
				description:
					"Three relevant health tips based on the users given info. Try hard to make it specific to the user. If insufficient info is given, provide three general health tips. Each tip should not be longer than 55 characters.",
			},
		};
